...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('generated_i_d_s', function (Blueprint $table) {
            ...
            $table->string('textContentsBack_0_fs');//stundent no
            $table->string('textContentsBack_0_ff');//stundent no

            $table->integer('textContentsBack_1_x');//address 1
            $table->integer('textContentsBack_1_y');//address 1
            $table->string('textContentsBack_1_fs');//stundent no
            $table->string('textContentsBack_1_ff');//stundent no

            $table->integer('textContentsBack_2_x');//contact number
            $table->integer('textContentsBack_2_y');//contact number
            $table->string('textContentsBack_2_fs');//stundent no
            $table->string('textContentsBack_2_ff');//stundent no

            $table->integer('textContentsBack_3_x');//semester
            $table->integer('textContentsBack_3_y');//semester
            $table->string('textContentsBack_3_fs');//stundent no
            $table->string('textContentsBack_3_ff');//stundent no

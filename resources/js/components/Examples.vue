...
import Upload from '../components/NewAdd.vue'
import previewID from '../components/newPreview.vue'
import View from '../components/newView.vue'
import Generate from '../components/newGenerate.vue'

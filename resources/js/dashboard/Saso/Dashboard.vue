        ...
        <aside id="sidebar" class="sidebar">
            <ul class="sidebar-nav" id="sidebar-nav">
                <li class="nav-item mt-3">
                    <router-link  to="/saso-dashboard" class="nav-link" exact-active-class="actives">
                        <i class="fas fa-th"></i>
                        <span>Dashboard</span>
                    </router-link>
                </li>
                <!-- End Dashboard Nav -->
                <li class="nav-item">
                    <router-link to="/saso-records"
                        class="nav-link"
                        exact-active-class="actives"
...
import Dashboard from '../../dashboard_resources/saso/DashboardMain.vue'

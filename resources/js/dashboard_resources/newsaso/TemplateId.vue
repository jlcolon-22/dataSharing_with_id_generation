        ...
        <div v-if="!!activeTemplate" class="card mt-5">
            ...
            <div class="card-body " style="padding: 10px 10px 10px 10px;">
                ...
                <div class="d-flex justify-content-between p-6">
                    <div class="col-md-4  rounded" style="padding-bottom: 20px;display: grid;grid-template-columns: repeat(2, minmax(0, 1fr));">
                        <div class="dropdown">
                        ...
                        <button class="btn border" :class=" boldActive ? 'btn-secondary' : '' " style="height: fit-content ;width: fit-content;" @click="boldActive = !boldActive"><strong>B</strong></button>
                ...
                <form @submit.prevent="savePositions" class="mt-5">
                    <div ref="container" class="d-grid gap-5" style="margin: 0 auto; width: fit-content;">
                        <div class="relative" style="position: relative; transform:scale(1.2)">
                            <p ref="first_name" style="position: absolute; user-select: none;">MICHEAL</p>
                            ...
                            <img ref="profile" src="/id_image/man.png"
                        ...
                        <div class="relative" style="position: relative;transform:scale(1.2)">
                            ...
                            <p ref="address" style="position: absolute;line-height: 90%;  user-select: none;text-align: center;">Barangay Malakas, Manila City</p>
...
const fontFamilies = ref([
    ...
    'Calibri', 'Century Gothic', 'Montserrat', 'Poppins', 'Arial Narrow',
    'Helvetica', 'Baskerville', 'Tahoma', 'Garamond', 'Franklin Gothic', 'Futura',
    'Cambria', 'Comfortaa', 'Proxima Nova', 'Roboto', 'Lato',
    'Quick Sand', 'Open Sans', 'Ubuntu', ' Avenir', 'Merriweather',
    'Frutiger', 'Public Sans', 'Bebas', 'Palatino',
...
const firstName_interact = () => {
    ...
    firstnamev.on('doubletap', function (event) {
        ...
        event.target.style.fontWeight = boldActive.value ? 'bold' : ''
        position.firstname.b = boldActive.value ? 'bold' : '';
...
const middleName_interact = () => {
    ...
    middlenamev.on('doubletap', function (event) {
        event.target.style.fontSize = selectedFont.value + 'px'
        event.target.style.fontWeight = boldActive.value ? 'bold' : ''
        position.middlename.b = boldActive.value ? 'bold' : '';
...
const lastName_interact = () => {
    ...
    lastnamev.on('doubletap', function (event) {
        event.target.style.fontSize = selectedFont.value + 'px'
        event.target.style.fontWeight = boldActive.value ? 'bold' : ''
        position.lastname.b = boldActive.value ? 'bold' : '';
...
const student_number_interact = () => {
    ...
    student_numberv.on('doubletap', function (event) {
        event.target.style.fontSize = selectedFont.value + 'px'
        event.target.style.fontWeight = boldActive.value ? 'bold' : ''
        position.student_number.b = boldActive.value ? 'bold' : '';
...
const course_interact = () => {
    ...
    coursev.on('doubletap', function (event) {
        event.target.style.fontSize = selectedFont.value + 'px'
        event.target.style.fontWeight = boldActive.value ? 'bold' : ''
        position.course.b = boldActive.value ? 'bold' : '';
...
const year_sem_interact = () => {
    ...
    yearsemv.on('doubletap', function (event) {
        ...
        event.target.style.fontWeight = boldActive.value ? 'bold' : ''
        position.year_sem.b = boldActive.value ? 'bold' : '';
        event.target.style.fontFamily = selectedFontFamily.value;
...
const contact_form_interact = () => {
    ...
    contact_formv.on('doubletap', function (event) {
        event.target.style.fontSize = selectedFont.value + 'px'
        event.target.style.fontWeight = boldActive.value ? 'bold' : ''
        position.contact_form.b = boldActive.value ? 'bold' : '';
...
const address_interact = () => {
    ...
    addressv.on('doubletap', function (event) {
        event.target.style.fontSize = selectedFont.value + 'px'
        event.target.style.fontWeight = boldActive.value ? 'bold' : ''
        position.address.b = boldActive.value ? 'bold' : '';
...
const number_interact = () => {
    ...
    numberv.on('doubletap', function (event) {
        event.target.style.fontSize = selectedFont.value + 'px'
        event.target.style.fontWeight = boldActive.value ? 'bold' : ''
        position.number.b = boldActive.value ? 'bold' : '';

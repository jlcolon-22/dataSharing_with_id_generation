            ...
            <div class="modal-content">
                ...
                <div class="modal-body col-md-12">
                    ...
                    <div class="conatiner row">
                        ...
                        <div class="col-sm-6">
                            <div class="card border-0 image-container" style="height: 300px;">
                                <img :src="signatureImage" alt="" class="centered-image" style="width: 250px; height: 150px;" id="capture-img" />
                                <!-- <Editor :canvasWidth="canvasWidth" :canvasHeight="canvasHeight" ref="editor" editorId="canvasId"/> -->
                            </div>
                        </div>
                    </div>
...
// upload signature using signature pad
const save = (t) => {
...
const fetchStudentSasoRecord = async () =>{
    ...
    if(res.status == 200)
    {
        ...
        capturedImage.value = res.data.image ? 'storage/studentImage/'+res.data.image : '/id_image/man.png' ;
        signatureImage.value = res.data.signature ? 'storage/signature/'+res.data.signature : '/id_signatures/signature.png';

    }else{
        studentDetails.value = [];
        capturedImage.value = '/id_image/man.png'
      signatureImage.value = '/id_signatures/signature.png';
    }
}
...
// upload signature using file input

    ...
    <div class="dashboard_header mt-2" style="margin-left: 13rem;">
        ...
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active" aria-current="page">Personal Sheet</li>
          </ol>
        </nav>
  </div>
...
// import modal
import viewModal from './PersonalSheet_Modal/ViewStudent_PersonalSheet.vue'
import editModal from './PersonalSheet_Modal/EditStudent_PersonalSheet.vue'
export default {
  components: {
    viewModal,
    editModal
